...
# У цьому боті користувач повинен вводити дані у форматі, визначеному для кожної команди:

#     Команда "hello":
#     Користувач вводить "hello".

#     Команда "add":
#     Користувач вводить "add [ім'я] [номер телефону]".

#     Команда "change":
#     Користувач вводить "change [ім'я] [новий номер телефону]".

#     Команда "phone":
#     Користувач вводить "phone [ім'я]".

#     Команда "all":
#     Користувач вводить "all".

#     Команда "close" або "exit":
#     Користувач вводить "close" або "exit".
...
#     Для додавання нового контакту з ім'ям "John" і номером телефону "1234567890" користувач вводить: "add John 1234567890".
#     Для оновлення номера телефону для контакту "John" на "0987654321" користувач вводить: "change John 0987654321".
#     Для отримання номера телефону для контакту "John" користувач вводить: "phone John".
#     Для виведення всіх збережених контактів користувач вводить: "all".
#     Для завершення роботи бота користувач вводить: "close" або "exit".